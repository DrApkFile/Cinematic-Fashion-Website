    ...
    <div className="container mx-auto px-4">
      ...
      >
        ...
        <p className="text-xl text-gray-400 max-w-2xl mx-auto">
          Have questions about our collections or interested in collaboration opportunities?
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-400">contact@elevate-fashion.com</p>
              </div>
            </div>
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute -inset-1 bg-gradient-to-r from-pink-600 to-cyan-600 rounded-lg blur opacity-25"></div>
          <div className="relative bg-black p-8 rounded-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="liquid-input-container">
                  <Textarea
                    ...
                    onChange={handleChange}
                    className="liquid-input min-h-[150px]"
                    required
                  />
                  <div className="liquid-input-highlight"></div>
                </div>
              ...
              <Button type="submit" className="liquid-button w-full">
